<%@ page import="com.LuoJing.Model.Product" %>
<%@ page import="java.sql.Connection" %>
<%@ page import="com.LuoJing.Model.Category" %>
		...
		<h2 class="title text-center">Product <strong>List</strong></h2> 
					...
					<!-- loop_start -->
						...
						<tr>
							...
							<%
								com.LuoJing.Model.Product p = (Product) pageContext.findAttribute("p");
								int pid = p.getProductId();
								java.sql.Connection con = (Connection) application.getAttribute("conn");
								String catName = Category.findByCaterotyID(con,pid);
							%>
