			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td>${o.orderDate}</td>
						<%
							com.LuoJing.Model.Order o=(com.LuoJing.Model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.LuoJing.Dao.UserDao userDao=new com.LuoJing.Dao.UserDao();
						...
						<%
							...
							String paymentType=com.LuoJing.Model.Payment.findByPaymentId(con,n);
							 %>
